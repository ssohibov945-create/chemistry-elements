...
(function (global) {
  ...
  const translations = {
    tg: {
      ...
      testTitle: '🧪 ТЕСТХО', testSub: '40 савол • 1 дақиқа', nextBtn: '▶ БА САВОЛИ ОЯНДА', restartBtn: '🔁 Аз нав оғоз', questionOf: 'Саволи {n} / {total}', scoreText: 'аз 40 дуруст',
    ...
    ru: {
      ...
      testTitle: '🧪 ТЕСТЫ', testSub: '40 вопросов • 1 минута', nextBtn: '▶ СЛЕДУЮЩИЙ', restartBtn: '🔁 Заново', questionOf: 'Вопрос {n} / {total}', scoreText: 'из 40 правильных',
    ...
    en: {
      ...
      testTitle: '🧪 TESTS', testSub: '40 questions • 1 minute', nextBtn: '▶ NEXT', restartBtn: '🔁 Restart', questionOf: 'Question {n} / {total}', scoreText: 'out of 40 correct',
  ...
  const quizQuestions = {
    tg: [
      ...
      { q: 'Валенти оксиген дар аксари пайвастҳо чанд аст?', o: ['1', '2', '3', '4'], c: 1 },
      { q: 'Кадом реаксия синтез аст?', o: ['2H₂O → 2H₂ + O₂', '2H₂ + O₂ → 2H₂O', 'Zn + 2HCl → ZnCl₂ + H₂', 'NaOH + HCl → NaCl + H₂O'], c: 1 },
      { q: 'Моли массаи об (H₂O) чанд г/мол аст?', o: ['16', '18', '20', '22'], c: 1 },
      { q: 'Кадом элемент дар гурӯҳи ҳалогенҳо ҷойгир аст?', o: ['O', 'S', 'Cl', 'N'], c: 2 },
      { q: 'Формулаи кислотаи сулфат кадом аст?', o: ['HCl', 'HNO₃', 'H₂SO₄', 'H₂CO₃'], c: 2 },
      { q: 'Кадом газ дар реаксияи сӯзиши метан ҳосил мешавад?', o: ['O₂', 'H₂', 'CO₂', 'N₂'], c: 2 },
      { q: 'Элементи №17 кадом аст?', o: ['Фтор', 'Хлор', 'Бром', 'Йод'], c: 1 },
      { q: 'Кадом навъи реаксия «ивази дучанда» аст?', o: ['A + B → AB', 'AB → A + B', 'AB + C → AC + B', 'AB + CD → AD + CB'], c: 3 },
      { q: 'Рамзи элементи «калий»?', o: ['P', 'K', 'Ca', 'Na'], c: 1 },
      { q: 'Дар молекулаи CO₂ чанд атом ҳаст?', o: ['2', '3', '4', '5'], c: 1 },
      { q: 'Кадом модда электролит аст?', o: ['Шакар', 'Намаки ош', 'Спирт', 'Бензин'], c: 1 },
      { q: 'Оксиди калсий чӣ формула дорад?', o: ['CaO', 'CaO₂', 'Ca₂O', 'Ca(OH)₂'], c: 0 },
      { q: 'Кадом элемент дар таркиби гемоглобин аст?', o: ['Cu', 'Fe', 'Zn', 'Mg'], c: 1 },
      { q: 'pH-и муҳити нейтралӣ чанд аст?', o: ['0', '5', '7', '14'], c: 2 },
      { q: 'Кадом олим қонуни ҳифзи массаро кашф кард?', o: ['Менделеев', 'Лавуазье', 'Бойл', 'Кюри'], c: 1 }
    ],
    ru: [
